...
hakukentta.addEventListener('keypress', function(event) {
  ...
  function etsinta() {
    ...
    if (hakukentta.value === "Uusimaa" || hakukentta.value === "uusimaa" ||
        hakukentta.value === "UUSIMAA") {
      Uusimaa();
    }
    else if (hakukentta.value === "Varsinais-Suomi" || hakukentta.value ===
        "varsinais-suomi" || hakukentta.value === "varsinais-Suomi" ||
        hakukentta.value === "Varsinais Suomi" || hakukentta.value ===
        "VARSINAIS SUOMI" || hakukentta.value === "varsinais suomi" ||
        hakukentta.value === "varsinaissuomi" || hakukentta.value ===
        "Varsinaissuomi" || hakukentta.value === "varsinaisSuomi") {
      VarsinaisSuomi();
    }
    else if (hakukentta.value === "Kymenlaakso" || hakukentta.value ===
        "kymenlaakso" || hakukentta.value === "KYMENLAAKSO") {
      Kymenlaakso();
    }
    else {
...
function Kymenlaakso() {
  ...
  let markkeri1 = L.marker([60.57190505523023, 26.704860335392915]).
      addTo(kartta).
      bindPopup("<b>Valkmusan kansallispuisto</b>");

  //Itäsien Suomelahden kansallispuisto
  let markkeri2 = L.marker([60.34859725763926, 27.457257986782444]).
      addTo(kartta).
      bindPopup("<b>Itäisen Suomenlahden kansallispuisto</b>");

  //Repoveden kansallispuisto
  let markkeri3 = L.marker([61.185316576818316, 26.89969205647982]).
      addTo(kartta).
      bindPopup("<b>Repoveden kansallispuisto</b>");
