...
function createMobileNavbar() {
    ...
    a.innerHTML =
        ...
        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" x="0px" y="0px" viewBox="0 0 256 256" xml:space="preserve">
            ...
            <path class="st3" d="M42.7,46.8L42.7,46.8c-5.4,5.4-5.4,14,0,19.4l150.2,150.2c5.4,5.4,14,5.4,19.4,0l0,0c5.4-5.4,5.4-14,0-19.4  L62.1,46.8C56.7,41.5,48,41.5,42.7,46.8z"/>
            <path class="st3" d="M212.3,46.8L212.3,46.8c-5.4-5.4-14-5.4-19.4,0L42.7,197.1c-5.4,5.4-5.4,14,0,19.4l0,0c5.4,5.4,14,5.4,19.4,0  L212.3,66.2C217.6,60.9,217.6,52.2,212.3,46.8z"/>
        </svg>
        `;
